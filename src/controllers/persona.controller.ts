...
export class PersonaController {
  ...
  async create(
    ...
    // Adicionalmente, al crear una persona en el sistema se le enviara un correo electrónico
    // con su usuario y contraseña. Por lo tanto se agrega este código luego de crear la persona.
